...
// Глобальные вспомогательные функции для перевода и стилизации
      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Исправлено: применяем _mapTaskType
            Text('Тип: ${_mapTaskType(task.taskType)}', style: const TextStyle(color: Colors.white54, fontSize: 14)),
            const SizedBox(height: 24),
            Container(
              padding: const EdgeInsets.all(16),
              decoration: BoxDecoration(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            // Исправлено: применяем _mapStatus и _getStatusColor
                            Text(
                              'Статус: ${_mapStatus(assignee.status)}',
                              style: TextStyle(
                                color: _getStatusColor(assignee.status),
                                fontSize: 13,
                              ),
                            ),
                          ],
