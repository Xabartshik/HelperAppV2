...
BulkPlaceResultDto _$BulkPlaceResultDtoFromJson(Map<String, dynamic> json) {
  return _BulkPlaceResultDto.fromJson(json);
}

/// @nodoc
mixin _$BulkPlaceResultDto {
  int get placedCount => throw _privateConstructorUsedError;
  int get remainingCells => throw _privateConstructorUsedError;

  /// Serializes this BulkPlaceResultDto to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of BulkPlaceResultDto
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $BulkPlaceResultDtoCopyWith<BulkPlaceResultDto> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BulkPlaceResultDtoCopyWith<$Res> {
  factory $BulkPlaceResultDtoCopyWith(
    BulkPlaceResultDto value,
    $Res Function(BulkPlaceResultDto) then,
  ) = _$BulkPlaceResultDtoCopyWithImpl<$Res, BulkPlaceResultDto>;
  @useResult
  $Res call({int placedCount, int remainingCells});
}

/// @nodoc
class _$BulkPlaceResultDtoCopyWithImpl<$Res, $Val extends BulkPlaceResultDto>
    implements $BulkPlaceResultDtoCopyWith<$Res> {
  _$BulkPlaceResultDtoCopyWithImpl(this._value, this._then);
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? placedCount = null, Object? remainingCells = null}) {
    return _then(
      _value.copyWith(
            placedCount: null == placedCount
                ? _value.placedCount
                : placedCount // ignore: cast_nullable_to_non_nullable
                      as int,
            remainingCells: null == remainingCells
                ? _value.remainingCells
                : remainingCells // ignore: cast_nullable_to_non_nullable
                      as int,
          )
          as $Val,
    );
...
/// @nodoc
abstract class _$$BulkPlaceResultDtoImplCopyWith<$Res>
    implements $BulkPlaceResultDtoCopyWith<$Res> {
  factory _$$BulkPlaceResultDtoImplCopyWith(
    _$BulkPlaceResultDtoImpl value,
    $Res Function(_$BulkPlaceResultDtoImpl) then,
  ) = __$$BulkPlaceResultDtoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({int placedCount, int remainingCells});
}
...
/// @nodoc
class __$$BulkPlaceResultDtoImplCopyWithImpl<$Res>
    extends _$BulkPlaceResultDtoCopyWithImpl<$Res, _$BulkPlaceResultDtoImpl>
    implements _$$BulkPlaceResultDtoImplCopyWith<$Res> {
  __$$BulkPlaceResultDtoImplCopyWithImpl(
    _$BulkPlaceResultDtoImpl _value,
    $Res Function(_$BulkPlaceResultDtoImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$BulkPlaceResultDtoImpl implements _BulkPlaceResultDto {
  const _$BulkPlaceResultDtoImpl({
    required this.placedCount,
    required this.remainingCells,
  });

  factory _$BulkPlaceResultDtoImpl.fromJson(Map<String, dynamic> json) =>
      _$$BulkPlaceResultDtoImplFromJson(json);
  ...
  @override
  String toString() {
    return 'BulkPlaceResultDto(placedCount: $placedCount, remainingCells: $remainingCells)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$BulkPlaceResultDtoImpl &&
            (identical(other.placedCount, placedCount) ||
                other.placedCount == placedCount) &&
            (identical(other.remainingCells, remainingCells) ||
                other.remainingCells == remainingCells));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, placedCount, remainingCells);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BulkPlaceResultDtoImplCopyWith<_$BulkPlaceResultDtoImpl> get copyWith =>
      __$$BulkPlaceResultDtoImplCopyWithImpl<_$BulkPlaceResultDtoImpl>(
        this,
        _$identity,
      );
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$BulkPlaceResultDtoImplToJson(this);
  }
}

abstract class _BulkPlaceResultDto implements BulkPlaceResultDto {
  const factory _BulkPlaceResultDto({
    required final int placedCount,
    required final int remainingCells,
  }) = _$BulkPlaceResultDtoImpl;

  factory _BulkPlaceResultDto.fromJson(Map<String, dynamic> json) =
      _$BulkPlaceResultDtoImpl.fromJson;
